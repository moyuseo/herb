...
<template>
  <div class="min-h-screen bg-[#FAF8F5]">
    <div class="max-w-6xl mx-auto px-4 py-8">
      <h1 class="text-2xl font-bold text-[#1B5E20] mb-6" style="font-family: 'Noto Serif SC', serif;">资讯中心</h1>
      ...
      <div class="flex flex-col md:flex-row md:items-center gap-4 mb-6">
        ...
        <div class="relative md:ml-auto md:w-72">
          ...
          <input
            ...
            type="text"
            placeholder="搜索新闻..."
            class="w-full pl-10 pr-4 py-2 rounded-full border border-gray-200 bg-white text-sm focus:outline-none focus:border-[#1B5E20]"
          />
        </div>
      </div>
        ...
        >
          ...
          <div class="flex flex-col justify-between p-4 flex-1 min-w-0">
            ...
            <div class="flex items-center gap-4 text-xs text-gray-400 mt-2">
              <span class="px-2 py-0.5 rounded bg-[#1B5E20]/10 text-[#1B5E20] font-medium">{{ item.category }}</span>
